...
public class RegistrarMedico extends JDialog {
	...
	public RegistrarMedico(Medico aux) {
		...
		contentPanel.setLayout(new BorderLayout(0, 0));
		{
			...
			cbPuesto.setModel(new DefaultComboBoxModel(
					new String[] { " <Seleccionar>", "Interno", "Especialista", "Residente" }));
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				btnRegistrar.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						if (camposVacios()) {
							JOptionPane.showMessageDialog(null, "Debe completar todos los campos", "Advertencia",
						...
						if (updated == null) {
							...
							Medico medico = new Medico(txtCedula.getText(), txtNombre.getText(), txtTelefono.getText(),
									txtDireccion.getText(), fecha, codigoMedico, cbPuesto.getSelectedItem().toString(),
									txtEspecialidad.getText(), sueldo);
							...
							JOptionPane.showMessageDialog(null, "Modificación Satisfactorio", "Información",
									JOptionPane.INFORMATION_MESSAGE);
							dispose();
						}
					}
	...
	private boolean camposVacios() {
		...
		else if (txtCedula.getText().isEmpty() || txtNombre.getText().isEmpty() || txtTelefono.getText().isEmpty()
				|| txtDireccion.getText().isEmpty() || txtEspecialidad.getText().isEmpty()) {
			return true;
		}
